  ...
  return (
    <>
      <AlertDialog
        ...
        setOpen={setOpen}
        title={"ALERT"}
        discription={"This Feature Will Be Live in 15 Days"}
      ></AlertDialog>
      <TooltipProvider>
              ...
              <TooltipTrigger asChild>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "bg-[#000000] hover:bg-[#000000]/85 text-primary-foreground"
                      : "hover:bg-[#f1f5f9] text-muted-foreground transition-colors hover:text-foreground"
                    // "default" === "default" &&
...
export const ExpandableNavigation: React.FC = () => {
  ...
  const navigationMenus: MenuType[] = [
    ...
    },
    {
      ...
      path: "https://partner.naai.in/invoice",
    },
    {
      title: "Expenses",
    ...
    },
    {
      ...
      path: "https://partner.naai.in/subscriptions",
    },
  ];
      ...
      >
        <nav
          className={cn(
            ...
            data.isCollapsed
              ? "items-start gap-4 px-2 sm:py-4"
              : "items-start gap-4 px-2 sm:py-4 overflow-y-scroll scrollbar-hide"
          )}
        >
          {
